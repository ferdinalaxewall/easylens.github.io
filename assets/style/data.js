...
function getDetailCameraData(id){
    for (let i = 0; i < cameraData.length; i++) {
        ...
        '                            <button class="button-variant selected" variant-value="6" data-price="'+ litePrice +'">6 Jam</button>'+
        '                            <button class="button-variant" variant-value="12" data-price="'+ mediumPrice +'">12 Jam</button>'+
        '                            <button class="button-variant" variant-value="24" data-price="'+ largePrice +'">24 Jam</button>'+
        '                        </div>'+
        '                    </div>'+
        '                    <div class="detail-produk__price">'+
        '                        <h3 class="price__title">Total:</h3>'+
        '                        <h1 class="price__number highlighted-text">Rp. 0</h1>'+
        '                        <a href="#" class="book-produk">'+
